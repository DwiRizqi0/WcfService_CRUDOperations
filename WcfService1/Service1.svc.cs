...
namespace WcfService1
{
    ...
    public class Service1 : IService1
    {
        ...
        {
            string Message;
            SqlConnection con = new SqlConnection("Data Source=laptop-hgh9ccba;Initial Catalog=MyTestDB;Persist Security Info=True;User ID=sa;Password=311000;Pooling=False");
            con.Open();
        ...
        public gettestdata GetInfo()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-HGH9CCBA;Initial Catalog=MyTestDB;Persist Security Info=True;User ID=sa;Password=311000;Pooling=False"); con.Open();
